...
const qnaList = [
  ...
  },
  {
    ...
    a: [
      { answer: '야, 칵테일 별로 안 세니까 그냥 마셔', type: [0,4,8,12,3,7,11,15] },
      { answer: '(바로 수긍하며) 좋아! <br>그럼 너를 위해서는 버진 칵테일을 만들어줄게', type: [1,2,5,6,9,10,13,14]},
    ],
  ...
  },
  {
    ...
    a: [
      ...
      { answer: '정해진 것이 어딨어! 내가 싫어하는 재료는 빼고 칵테일을 만든다.', type: [6,10,3,15] },
    ],
  ...
  },
  {
    ...
    a: [
      ...
      { answer: '일단 친구가 기다리고 있으니까 빨리 대형 마트로 출발해!', type: [4,5,6,7,8,9,10,11]},
    ],
  ...
  },
  {
    ...
    a: [
      { answer: '친구 기준 말고 내 기준에서 더 맛있는 음료를 먹어야해. 생과일을 사자.', type: [1,2,13,14] },
      { answer: '잘 모르는데 괜찮을거야. 그냥 과일 주스를 사자', type: [4,7,8,11]},
    ],
...

  {
    ...
    a: [
      ...
      { answer: '아직 포기하긴 일러.. 한 두세군데만 더 가	보자', type: [6,7,10,11] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: '믹서기를 안 쓰는 칵테일을 만들어준다고 친구를 설득해 보자.', type: [0,12,2,14,9,13] },
      { answer: '윗집에 조금 미안하긴 하지만.. 무조건 원래 계획대로 만들려던 것을 만들자.', type: [15,11,7,3]},
    ],
  ...
  },
  {
    ...
    a: [
      { answer: '유리잔', type: [0,1,2,4,6,12,13,14] },
      { answer: '와인잔처럼 기둥이 있는 잔', type: [5,9,10,15] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: '오래 걸리지 않는 패스트푸드',type: [0,4,8,12] },
      { answer: '칵테일에는 든든한 국밥!', type: [1,5,9,13]},
    ],
  ...
  },
  {
    ...
    a: [
      ...
      { answer: '그냥 남은 거 어차피 잘 안먹을텐데 바로 버릴래.', type: [4,5,6,7,8,9,10,11]},
    ],
  ...
  },
  {
    ...
    a: [
      { answer: '얘들아! 그냥 여기서 자고 가!', type: [2,3,6,7,10,11,14,15]},
...
const infoList = [
  ...
  },
  {
    ...
    - 준비가 되어 있어야 한다<br>\
    - 갈등을 기피한다<br>\
    - 비판과 비난은 나를 힘들게 한다<br>\
    - 과거에 받은 상처를 잘 잊지 못한다<br>\
    - 높은 지위를 부담스러워 한다<br>\
    - 일관성을 지향한다<br>\
    - 평화로운 일상을 중요시한다<br>\
    - 변화를 기피한다<br>\
    - 누군가가 자신을 필요로 할 때 행복을 느낀다<br>\
    - 화를 잘 내지 못한다<br>\
    - 법과 규칙을 준수한다<br>\
    - 빈말인지 알아도 들으면 기분이 좋다<br>\
    - 참을성이 굉장히 좋은 편<br>\
    '
  },
  {
