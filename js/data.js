/*
1 - Golden Medalist (ENTJ)
2 - Bloody Mary (INTP)
3 - Cinderella (ISTP)
4 - Sunrise (ISFP)
5 - Shirley Temple (ESFJ)
6 - Prairie Oyster (ISTJ)
7 - Pina Colada (ENTP)
8 - Cuba Libre (INTJ)
9 - Florida (ISFJ)
10 - Mojito Lime (ENFJ)
11 - Barbados Surprise (ESTP)
12 - Peach Crush (INFP)
13 - Strawberry Daiquiri (ESFP)
14 - Blue Hawaiian (ENFP)
15 - Grasshopper (INTJ)
16 - Arnold Palmer (INFJ)
*/
...
const qnaList = [
  {
    ...
    a: [
      { answer: '각양각색 무지개빛 화려한', type: [0,1,2,3,4] },
      { answer: '중후한 느낌의 투명한 갈색빛',type: [0,1,2,3,4] },
      { answer: '노랑, 주황, 파랑같은 밝은 빛깔의 은은한', type: [0,1,2,3,4] },
    ],
  ...
  },
  {
    ...
    a: [
      { answer: '야, 칵테일 별로 안 세니까 그냥 마셔', type: [0,1,2,3,4] },
